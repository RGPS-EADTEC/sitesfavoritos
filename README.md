...
Fique atento para colocar o link correto das imagens na codificação da página e, caso a opção seja usar as imagens localmente no dispositivo, você deve criar uma pasta   contendo o arquivo HTML da atividade, as devidas imagens, captura de tela do código (com comentários nas linhas) e captura da execução da página web no navegador. ADICIONAR O PROJETO PARA ENVIO NO GITHUB.
